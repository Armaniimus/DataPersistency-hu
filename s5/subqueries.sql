...
SELECT DISTINCT voorl AS voorletters, naam AS Achternaam
FROM medewerkers
INNER JOIN inschrijvingen
	ON inschrijvingen.cursist = medewerkers.chef
INNER JOIN uitvoeringen
ON uitvoeringen.docent = medewerkers.mnr
	AND inschrijvingen.begindatum = uitvoeringen.begindatum
	AND inschrijvingen.cursus = uitvoeringen.cursus
